...
const darkmode = () => {
    ...
    return (
        <div>
            <input className="dark_mode_input" id="darkmode-toggle" type="checkbox" onChange={toggleTheme} />
            <label className='dark_mode_label' for='darkmode-toggle'>
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-brightness-low-fill" viewBox="0 0 16 16" className="sun">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-moon-fill" viewBox="0 0 16 16" className="moon">
